...
from tkinter import ANCHOR, CENTER, LEFT, ttk
import sys
...
class Application(tk.Tk, Configure_widgets):
    ...
    def set_ui(self):
        ...
        self.combo_win = ttk.Combobox(self.bar2, values=["hide",
                                                                "don't hide", "min"],
                                                                width=9,
                                                                state="readonly")
    ...
    def make_bar_cpu_usage(self):
        ttk.Label(self.bar, text=f"Physical cores: {self.cpu.cpu_count}, threads: {self.cpu.cpu_count_logical}",
